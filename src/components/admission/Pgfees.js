...
//import directories
import { ugadmissionfees, ugsemfees } from "@/dictionary/Admissionlinks";

const Pgfees = () => {
  return (
    <div>
      <AnimatedText
        text="B. Tech Fees Structure"
      ...
      <div>
        ...
        <div>
          ...
          <div className="flex flex-wrap rounded-2xl p-4 w-full justify-center">
            <div className="rounded-2xl w-fit shadow-news-shadow md:overflow-x-scroll">
              <table className="table rounded-2xl w-fit">
                ...
                <tbody>
                  {ugadmissionfees.map((fees, index) =>
                    fees.sum === false ? (
            ...
            <div className="mt-4 text-xl italic font-serif font-medium text-gray-600">
              <p className="mb-2">*Payable as per amount charged by NIC.</p>
              <p>**Payable as per amount charged by MAKAUT.</p>
            </div>
          </div>
        </div>
        <div className="mt-6">
