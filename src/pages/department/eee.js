...
//import dictionaries
import { eeebanner } from "@/dictionary/Bannerlist";
import {
  eeelinks,
  eeephotos,
  eeelabs,
        ...
        <Layout className="!pt-8">
          ...
          >
            ...
            <motion.div variants={childitem}>
              ...
              <div className="flex gap-4 ml-3 my-1">
                ...
                <motion.a
                  variants={childitem}
                  href="mailto:hod_eee@aot.edu.in"
                  target="_blank"
                  className="text-xl font-serif align-middle font-semibold text-[hsl(232,47%,28%)]"
                >
                  hod_eee@aot.edu.in
          ...
          >
            ...
            <motion.div variants={childitem3} className="my-2">
              <News props={newslinks} newsview="/department/eeenewsview" />
            </motion.div>
          </motion.div>
          <motion.div
            variants={parent}
