export const balinks = [
  ...
  },
  {
    ...
    submenu: true,
    sublinks: [
      { name: "Faculty Members", href: "/department/ba#faculty" },
      { name: "Staff Members", href: "/department/ba#staff" },
    ],
  },
  {
    name: "Students",
    submenu: true,
    sublinks: [
      { name: "Placement", href: "/department/ba#placements" },
      { name: "Student Activities", href: "/department/ba#activities" },
      { name: "Life@AOT_Dept", href: "/department/ba#infrastructure" },
      { name: "Newsletter & Events", href: "/department/ba#newsletter" },
    ],
  },
  {
    name: "Academics",
    submenu: false,
    href: "/department/ba#academics",
  },
  {
    name: "Research",
    submenu: false,
    href: "/department/ba#research" ,
  },
  {
    name: "Achievements",
    submenu: false,
    href: "/department/ba#achievements" ,
  },
  {
    name: "Join Us",
    submenu: false,
