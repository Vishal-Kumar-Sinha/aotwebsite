export const itlinks = [
  ...
  },
  {
    ...
    submenu: true,
    sublinks: [
      { name: "Faculty Members", href: "/department/it#faculty" },
      { name: "Staff Members", href: "/department/it#staff" },
    ],
  },
  {
    name: "Students",
    submenu: true,
    sublinks: [
      { name: "Placement", href: "/department/it#placements" },
      { name: "Student Activities", href: "/department/it#activities" },
      { name: "Life@AOT_Dept", href: "/department/it#infrastructure" },
      { name: "Newsletter & Events", href: "/department/it#newsletter" },
    ],
  },
  {
    name: "Academics",
    submenu: false,
    href: "/department/it#academics",
  },
  {
    name: "Research",
    submenu: false,
    href: "/department/it#research" ,
  },
  {
    name: "Achievements",
    submenu: false,
    href: "/department/it#achievements" ,
  },
  {
    name: "Join Us",
    submenu: false,
