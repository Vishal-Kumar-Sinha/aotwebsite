      ...
      <div>
        <div className="px-6 py-2 ml-10 font-serif text-lg w-fit">
          <ul style={{ listStyleType: "number" }}>
            ...
            <li className="my-2">
              Hostel seat rents are payable on 6 months basis in cash or by Bank
              Draft of ₹15000/- favouring Academy of Technology payable at
              Kolkata.
            </li>
            <li className="my-2">
            ...
            <li className="my-2">
              Caution Deposit will be refunded only after the student passes the
              Final Examination or discontinues study mid-way.
            </li>
            <li className="my-2">
              * B. Tech (4 years) Students should register themselves for
              “Employbility skill Developement Tutorial” on cost basis. Tution
              fees of Rs.36,000/- have to be deposited as per following schedule
              for B. Tech 2022-23 admission batch students:
              <p className="mt-2 mx-4 font-semibold">₹ 12,000/- (First Year)</p>
              <p className="my-1 mx-4 font-semibold">
                ₹ 12,000/- (Second Year)
              </p>
              <p className="mb-2 mx-4 font-semibold">₹ 12,000/- (Third Year)</p>
            </li>
            <li className="my-2">
              * B. Tech Lateral Students should register themselves for
              “Employbility skill Developement Tutorial” on cost basis. Tution
              fees of Rs.24,000/- have to be deposited as per following schedule
              for B. Tech Lateral & MCA 2022-23 admission batch students:
              <p className="mt-2 mx-4 font-semibold">
                ₹ 12,000/- (Second Year)
              </p>
              <p className="mb-2 mx-4 font-semibold">₹ 12,000/- (Third Year)</p>
            </li>
            <li className="my-2">
              * MCA Students should register themselves for “Employbility skill
              Developement Tutorial” on cost basis. Tution fees of Rs.12,000/-
              have to be deposited as per following schedule for B. Tech Lateral
              & MCA 2022-23 admission batch students:
              <p className="my-2 mx-4 font-semibold">₹ 12,000/- (First Year)</p>
            </li>
            <li className="my-2">
              Students fees for Arcadia, the annual cultural event of the
              institute, are payable separately and to be paid with the semester
              fees of 2nd, 4th, 6th and 8th semesters.
            </li>
            <li className="my-2">
              Structure of fees and deposits may change based on the decision of
