...
//import dictionaries
import { eiebanner } from "@/dictionary/Bannerlist";
import {
  eielinks,
  eiephotos,
  eielabs,
        ...
        <Layout className="!pt-8">
          ...
          >
            ...
            <motion.div variants={childitem}>
              ...
              <div className="flex gap-4 ml-3 my-1">
                ...
                <motion.a
                  variants={childitem}
                  href="mailto:hod_eie@aot.edu.in"
                  target="_blank"
                  className="text-xl font-serif align-middle font-semibold text-[hsl(232,47%,28%)]"
                >
                  hod_eie@aot.edu.in
          ...
          >
            ...
            <motion.div variants={childitem3} className="my-2">
              <News props={newslinks} newsview="/department/eienewsview" />
            </motion.div>
          </motion.div>
          <motion.div
            variants={parent}
