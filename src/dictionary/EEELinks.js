export const eeelinks = [
  ...
  },
  {
    ...
    submenu: true,
    sublinks: [
      { name: "Faculty Members", href: "/department/eee#faculty" },
      { name: "Staff Members", href: "/department/eee#staff" },
    ],
  },
  {
    name: "Students",
    submenu: true,
    sublinks: [
      { name: "Placement", href: "/department/eee#placements" },
      { name: "Student Activities", href: "/department/eee#activities" },
      { name: "Life@AOT_Dept", href: "/department/eee#infrastructure" },
      { name: "Newsletter & Events", href: "/department/eee#newsletter" },
    ],
  },
  {
    name: "Academics",
    submenu: false,
    href: "/department/eee#academics",
  },
  {
    name: "Research",
    submenu: false,
    href: "/department/eee#research" ,
  },
  {
    name: "Achievements",
    submenu: false,
    href: "/department/eee#achievements" ,
  },
  {
    name: "Join Us",
    submenu: false,
