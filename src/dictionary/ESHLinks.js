export const eshlinks = [
  ...
  },
  {
    ...
    submenu: true,
    sublinks: [
      { name: "Faculty Members", href: "/department/esh#faculty" },
      { name: "Staff Members", href: "/department/esh#staff" },
    ],
  },
  {
    name: "Students",
    submenu: true,
    sublinks: [
      { name: "Placement", href: "/department/esh#placements" },
      { name: "Student Activities", href: "/department/esh#activities" },
      { name: "Life@AOT_Dept", href: "/department/esh#infrastructure" },
      { name: "Newsletter & Events", href: "/department/esh#newsletter" },
    ],
  },
  {
    name: "Academics",
    submenu: false,
    href: "/department/esh#academics",
  },
  {
    name: "Research",
    submenu: false,
    href: "/department/esh#research" ,
  },
  {
    name: "Achievements",
    submenu: false,
    href: "/department/esh#achievements" ,
  },
  {
    name: "Join Us",
    submenu: false,
