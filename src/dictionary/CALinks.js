export const calinks = [
  ...
  },
  {
    ...
    submenu: true,
    sublinks: [
      { name: "Faculty Members", href: "/department/ca#faculty" },
      { name: "Staff Members", href: "/department/ca#staff" },
    ],
  },
  {
    name: "Students",
    submenu: true,
    sublinks: [
      { name: "Placement", href: "/department/ca#placements" },
      { name: "Student Activities", href: "/department/ca#activities" },
      { name: "Life@AOT_Dept", href: "/department/ca#infrastructure" },
      { name: "Newsletter & Events", href: "/department/ca#newsletter" },
    ],
  },
  {
    name: "Academics",
    submenu: false,
    href: "/department/ca#academics",
  },
  {
    name: "Research",
    submenu: false,
