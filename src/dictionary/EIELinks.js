export const eielinks = [
  ...
  },
  {
    ...
    submenu: true,
    sublinks: [
      { name: "Faculty Members", href: "/department/eie#faculty" },
      { name: "Staff Members", href: "/department/eie#staff" },
    ],
  },
  {
    name: "Students",
    submenu: true,
    sublinks: [
      { name: "Placement", href: "/department/eie#placements" },
      { name: "Student Activities", href: "/department/eie#activities" },
      { name: "Life@AOT_Dept", href: "/department/eie#infrastructure" },
      { name: "Newsletter & Events", href: "/department/eie#newsletter" },
    ],
  },
  {
    name: "Academics",
    submenu: false,
    href: "/department/eie#academics",
  },
  {
    name: "Research",
    submenu: false,
    href: "/department/eie#research" ,
  },
  {
    name: "Achievements",
    submenu: false,
    href: "/department/eie#achievements" ,
  },
  {
    name: "Join Us",
    submenu: false,
