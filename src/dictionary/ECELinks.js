export const ecelinks = [
    ...
    },
    {
      ...
      submenu: true,
      sublinks: [
        { name: "Faculty Members", href: "/department/ece#faculty" },
        { name: "Staff Members", href: "/department/ece#staff" },
      ],
    },
    {
      name: "Students",
      submenu: true,
      sublinks: [
        { name: "Placement", href: "/department/ece#placements" },
        { name: "Student Activities", href: "/department/ece#activities" },
        { name: "Life@AOT_Dept", href: "/department/ece#infrastructure" },
        { name: " Departmental Newsletter", href: "/department/ece#newsletter" },
      ],
    },
    {
      name: "Academics",
      submenu: false,
      href: "/department/ece#academics",
    },
    {
      name: "Research",
      submenu: false,
      href: "/department/ece#research" ,
    },
    {
      name: "Achievements & Events",
      submenu: false,
      href: "/department/ece#achievements" ,
    },
    {
      name: "Join Us",
      submenu: false,
